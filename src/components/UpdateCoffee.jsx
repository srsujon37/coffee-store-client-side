...
const UpdateCoffee = () => {
    ...
    const {_id,name, price, chef, supplier, taste, photo,details} = useLoaderData()
     const handleUpdateCoffee = (e) =>{
        ...
        fetch(`https://coffee-store-server-side-nine.vercel.app/coffees/${_id}`,{
            method: "PUT",
            headers: {
        ...
        .then(data =>{
            if (data.modifiedCount) {
                Swal.fire({
                    position: "top-end",
                    icon: "success",
                    title: "Coffee Ppdated Successfully!",
            ...
            <div className='p-24'>
                ...
                <form onSubmit={handleUpdateCoffee}  action="">
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        ...
                        <input type="text" name='price' defaultValue={price} className="input w-full" placeholder="Enter Coffee Price Per Cup" />
                        </fieldset>
                        {/* Details */}
                        <fieldset className="fieldset bg-base-300 border-base-300 rounded-box border p-4">
                    ...
                    {/* photo */}
                        ...
                        <input type="text" name='photo' defaultValue={photo} className="input w-full" placeholder="Enter Coffee photo url" />
                        </fieldset>
